...
ggplot(df1, aes(x = Year.of.Birth, y = Count )) +
  ...
  labs(title = "Most popular name for Male Hispanics ", subtitle = "(2011 - 2019)", x = "Birth Year", y = "Frequency")
...
ggplot(df1, aes(x = Year.of.Birth, y = Count )) +
  ...
  geom_text(aes(label = c(Count)), nudge_x = 0.25, nudge_y = 5, color = "black", size = 3.5) +
  scale_x_discrete(limits = c(2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018,2019)) +
  labs(title = "Most popular name for Male White Non-Hispanics ", subtitle = "(2011 - 2019)", x = "Birth Year", y = "Frequency")
...
ggplot(df1, aes(x = Year.of.Birth, y = Count )) +
  ...
  geom_text(aes(label = c(Count)), nudge_x = 0.25, nudge_y = 5, color = "black", size = 3.5) +
  scale_x_discrete(limits = c(2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018,2019)) +
  labs(title = "Most popular name for  Male Asian Pacific Islanders", subtitle = "(2011 - 2019)", x = "Birth Year", y = "Frequency")   
...
ggplot(df1, aes(x = Year.of.Birth, y = Count )) +
  ...
  geom_text(aes(label = c(Count)), nudge_x = 0.25, nudge_y = 5, color = "black", size = 3.5) +
  scale_x_discrete(limits = c(2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018,2019)) +
  labs(title = "Most popular name forMale Black Non-Hispanics", subtitle = "(2011 - 2019)", x = "Birth Year", y = "Frequency")   
