...
-   How have naming trends evolved over the years for different genders and ethnicities?
-   Which names are most commonly chosen within specific ethnic groups? and Are there any notable variations in naming preferences among different ethnicities?
...
-   may use a time plot to show the trend of the popular names over time overall and with respect to different categories.
-   We can tryo to find any correlations of names with variables like gender and ethnicity.
